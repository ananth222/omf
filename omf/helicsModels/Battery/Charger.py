...
if __name__ == "__main__":
    ...
    #   federate.
    numLvl1, numLvl2, numLvl3, EVlist = get_new_EV(pub_count-1)
    #charging_voltage = calc_charging_voltage(EVlist)
    with open("rates.csv", 'rb') as v : voltages = v.read().decode().split(",")
    charging_voltage = [int(v) for v in voltages]
    currentsoc = {}
    ...
    while grantedtime < total_interval:
        ...
        #publish to observer
        h.helicsPublicationPublishString(pubid[pub_count-1], "You see me!")
    ...
    xaxis.tofile(fileTime,",")
    yaxis.tofile(filePower,",")
